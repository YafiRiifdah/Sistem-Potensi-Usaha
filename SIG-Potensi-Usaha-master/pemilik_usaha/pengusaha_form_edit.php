        ...
        <td valign="top" width="80%">
		  ...
		  if (isset($_GET['no_ktp'])) {
            ...
            $data = mysql_fetch_array($result)?>
              ...
              <form method="POST" action="pengusaha_proses_edit.php" enctype="multipart/form-data" class="form-horizontal">
                ...
                <tr>
                  <td colspan=2>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <textarea type="text" class="form-control" id="alamat" name="alamat" value="<?=$data['alamat']?>"><?=$data['alamat']?></textarea>
                        </div>
                      </div>
                      <div class="form-group">
