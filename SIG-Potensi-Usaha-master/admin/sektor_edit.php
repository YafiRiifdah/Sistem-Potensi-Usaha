        ...
        <td valign="top">
          ...
          <?php
            ...
            if($banyakrecord>0)
            {
              ...
              <table class="table table-striped" align="center">
                <tr>
                  <td colspan=3 align="center" valign="middle"><font></font><h3>Edit Data Sektor Usaha</h3></td>
                </tr>
                <tr>
                  <td align="center">ID Sektor</td>
              ...
              while($data=mysql_fetch_array($result))
              {
                ...
                ?>
                <tr>
                  <form method="get" action="sektor_form_edit.php">
                  <td align="center">
