      ...
      <tr> 
        ...
        <td valign="top" width="80%">
          ...
          if (isset($_GET['id_gambar'])) {
            ...
            $link = koneksi_db();
            $sql = "SELECT * FROM galeri WHERE id_gambar='$id_gambar'";
            $result=mysql_query($sql, $link);
            $banyakrecord=mysql_num_rows($result);
            if ($banyakrecord==1) {
              $data = mysql_fetch_array($result)?>

              <form method="POST" action="galeri_proses_edit.php" enctype="multipart/form-data" class="form-horizontal">
                  ...
                  <td align="center" colspan=2>
                    ...
                    <div class="panel panel-primary">
                      <div class="panel-heading">
                        <h3 class="panel-title">Edit Data Galeri</h3>
                      </div>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td colspan=2>
                      <div class="form-group">
                        <div class="col-sm-8">
                          <input type="hidden" class="form-control" id="id_gambar" name="id_gambar" value="<?=$data['id_gambar']?>">
                        </div>
                      </div>
                      <div class="form-group">
